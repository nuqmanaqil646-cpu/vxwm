...
static const char *fonts[]          = {  "JetBrainsMono Nerd Font:size=13", "Latin Modern Math:size=15", "monospace:size=10" };
static const char dmenufont[]       = "Latin Modern Math:size=15";

#if !XRDB //when xrdb is turned off

static const char col_bg[]     = "#0A0A0A";  // dark background
static const char col_bg2[]    = "#222222";  // slightly lighter
static const char col_fg[]     = "#EEEEEE";  // text color
static const char col_fg_dim[] = "#555555";  // dim text
static const char col_accent[] = "#BBBBBB";  // highlight color
...
static char *colors[][3] = {
       /*               fg           bg           border   */
      [SchemeNorm] = { "#555555", "#0A0A0A", "#222222" }, 
      [SchemeSel]  = { "#EEEEEE", "#222222", "#BBBBBB" }, 
};
...
static const char *const autostart[] = {
    "feh --bg-fill /home/akaz/Downloads/wallhaven-j3p63p_1920x1080.png",
    "dwmblocks",
    "picom",
